...
public class ListView extends AppCompatActivity {
    android.widget.ListView dataView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.listview_crud);
        ...
        dataView = (android.widget.ListView)findViewById(R.id.dataView);
        ...
        arrayAdapter = new ArrayAdapter(
                ListView.this, android.R.layout.simple_list_item_1,
                data
        );
